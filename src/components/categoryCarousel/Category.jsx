export const CategoryPill = ({ label, imageUrl }) => {
    return (
      <button
        className="group relative inline-flex h-[48px] w-[170px] items-center justify-center overflow-hidden rounded-[24px] shadow-sm ring-1 ring-black/5 transition-transform duration-200 hover:scale-[1.02] focus:scale-[1.02] focus:outline-none"
        aria-label={label}
        type="button">
        {/* Hintergrundbild */}
        <img
