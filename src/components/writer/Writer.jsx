      ...
      <div className="flex items-center gap-3 justify-between">
        ...
        <div className="flex items-center gap-7">
          <div className="flex items-center gap-2">
            ...
            <StarIcon /> {`Rate:${author.rate}`}
          </div>
          <div className="flex items-center gap-2">
            
            <UserIcon /> {`Follower: ${formatNumber(author.follower)}`}
          </div>
          <div className="flex items-center gap-2">
            
            <PostIcon /> {`Post:${author.post}`}
          </div>
        </div>
        <div>
          <button className="bg-red-400 px-4 py-2 rounded-xl text-white font-bold cursor-pointer">
